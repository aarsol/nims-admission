...
class ResConfigSettings(models.TransientModel):
    ...
    repeat_grades_allowed_no = fields.Char(string="Repeat Times Allowed", config_parameter='odoocms.repeat_grades_allowed_no', default='1')
    ...
    deficient_course_in_summer = fields.Char(string="Registration of Deficient Course in Summer Allowed", config_parameter='odoocms.deficient_course_in_summer', default='False')
    advance_course_in_summer = fields.Char(string="Registration of Advance Course in Summer Allowed", config_parameter='odoocms.advance_course_in_summer', default='False')