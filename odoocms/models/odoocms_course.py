...
class OdooCMSCourseType(models.Model):
    ...
    # scheme_line_ids = fields.One2many('odoocms.study.scheme.line', 'subject_type_id', 'Subjects')
...
class OdooCMSCourse(models.Model):
    ...
    prerequisite_ids = fields.One2many('odoocms.course.prerequisite', 'course_id', string='Pre-Requisites', tracking=True)
