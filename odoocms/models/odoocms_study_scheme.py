...
class OdooCMSStudyScheme(models.Model):
    ...
    session_id = fields.Many2one('odoocms.academic.session','Calendar Year')   # needs to remove
...
class OdooCMSStudySchemeLine(models.Model):
    ...
    room_ids = fields.Many2many('odoocms.room', 'scheme_line_room_rel', 'scheme_line_id', 'room_id', 'Rooms')
    ...
    prerequisite_ids = fields.One2many('odoocms.study.scheme.line.prerequisite', 'scheme_line_id', string='Pre-Requisites', tracking=True,
        compute='_compute_components',store=True, copy=False, readonly=False)
...
class OdooCMSStudySchemeLinePreRequisite(models.Model):
    ...
    prerequisite_ids = fields.Many2many('odoocms.course', 'scheme_line_prerequisite_course_rel', 'scheme_line_id', 'course_id', string='Prerequisite Courses')
